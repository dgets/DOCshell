...
for(var c=0; c<10; c++) {
	...
	if(bbs.login(str, "\1n\1c\1hPW:\b\b\bPassword: \1w")) {
		bbs.logon();
		//additions by Khelair for sane ddoc2.js environment
...
/*
 * I do believe these should go where I put them above, though
//additions by Khelair in order to keep a sane environment for ddoc2.js
u.settings &= USER_SPIN;
u.settings &= USER_ANFSCAN;
u.settings &= USER_ASK_NSCAN;
u.settings &= USER_ASK_SSCAN;
*/
